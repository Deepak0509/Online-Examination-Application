package com.examportalbackend.configurations;
...
import com.examportalbackend.services.implementation.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests()
				...
				.antMatchers("/api/register").permitAll().antMatchers("/api/login").permitAll()
				...
				.anyRequest().denyAll().and().sessionManagement()
